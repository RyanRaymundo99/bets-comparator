    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      {currentStep === 2 && (
        <Card>
          <CardContent className="p-6">
            <div className="text-center space-y-6">
              <Key className="w-16 h-16 mx-auto text-blue-500" />
              <div>
                <h3 className="text-lg font-semibold mb-2">
      ...
      {currentStep === 3 && (
        <Card>
          <CardContent className="p-6">
            <div className="text-center space-y-6">
              <Download className="w-16 h-16 mx-auto text-orange-500" />
              <div>
                <h3 className="text-lg font-semibold mb-2">
                  Save Backup Codes
                </h3>
              ...
              <Button onClick={downloadBackupCodes} className="w-full max-w-sm">
            ...
            <div className="text-center space-y-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  ...
                  your account. Your account is now more secure!
                </p>
              </div>
      ...
      {/* Cancel Button */}
      {currentStep > 0 && currentStep < 4 && onCancel && (
